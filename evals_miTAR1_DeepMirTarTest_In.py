...
from utils import formatDeepMirTar2, padding_len, convert3D, flatten, evals, padding
...
bestModel = load_model('results/miTAR1_CNN_BiRNN_b30_lr0.005_dout0.2.h5')
...
inputf = "data/data_DeepMirTar_test.txt"
seqs, label =  formatDeepMirTar2(inputf)
x = [x[0] for x in seqs]
x = padding_len(x, 79)
y = [int(y) for y in label]
