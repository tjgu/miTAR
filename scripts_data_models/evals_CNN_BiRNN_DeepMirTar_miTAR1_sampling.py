...
for seed in seeds:
	...
	mcp = ModelCheckpoint(filepath='results/sampling/miTAR1_CNN_BiRNN_b' + str(batch) + '_lr' + str(lr) + '_dout' + str(dout) + '_seed' + str(seed) + '_1122.h5', monitor='val_acc', mode='max', save_best_only=True, verbose=1)
	...
	bestModel = load_model('results/sampling/miTAR1_CNN_BiRNN_b' + str(batch) + '_lr' + str(lr) + '_dout' + str(dout) + '_seed' + str(seed) + '_1122.h5')
...
outfName = 'results/sampling/miTAR1_CNN_BiRNN_b' + str(batch) + '_lr' + str(lr) + '_dout' + str(dout) + '_seeds_1122_evals.txt'
